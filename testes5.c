...
int main()
{
    ...
    //system("C:/Users/jbweb/Orca_Bolsa/orca-rt-bench/bin/orca-rt-scheduler.exe 8 C:/Users/jbweb/Orca_Bolsa/orca-rt-bench/datapack/orca-rt-scheduler/waters2019.ogm EDF");
    SetTargetFPS(60);
    //---------------------------------------------------------------------------------------
